/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 508210f974c3eec9273bd25bc4e081bd)
// Runtime types generated with workerd@1.20260317.1 2026-03-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./server-entry");
		durableNamespaces: "SharedCounterDO" | "SharedReactionBoardDO";
	}
	interface Env {
		SHARED_COUNTER: DurableObjectNamespace<import("./server-entry").SharedCounterDO>;
		SHARED_GUESTBOOK: DurableObjectNamespace<import("./server-entry").SharedReactionBoardDO>;
	}
}
